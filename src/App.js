    ...
    <div className="_body">
      <div className="_container">
        <Form onSubmit={submitHandler}>
          <Header as="h1" style={{ marginBottom: 20, textAlign: 'center' }}>
          ...
          <Form.Field required inline>
            <label>
              Type of Entity (corporation, institution of higher education,
              etc…)
            </label>
            <Input
              required
          ...
          <Form.Group inline>
            ...
            <div className="_group">
              ...
              {!body.agreementList.isFirstDayOfMonth && (
                <Form.Field required inline style={{ marginTop: 10 }}>
                  <label>Please specify date:</label>
                  <Input
                    type="date"
                    required
          ...
          {body.services.credentialsOrEarners === 'credentials' ? (
                ...
                <div className="_group">
                  <Form.Group inline>
                    <Form.Field
                      ...
                      checked={
                        body.services.willPurchaseHistoricCredentials === true
                      }
                      onChange={(e, { value }) =>
                        setData(
                          'services',
            ...
            <Form.Group grouped>
              <Form.Group inline>
                <label>
                  Will the client purchase Historical Active Earners?
                </label>
                <div className="_group">
                  <Form.Group inline>
                    <Form.Field
              ...
              <div className="_group">
                <Form.Group inline>
                  ...
                  <Form.Field
                    ...
                    name="willPurchaseTalentDirectory"
                    checked={
                      body.services.willPurchaseTalentDirectory === false
                    }
                    onChange={(e, { value }) =>
                      setData('services', 'willPurchaseTalentDirectory', value)
                    }
            ...
            <Form.Group inline>
              ...
              <div className="_group">
                ...
                {body.services.willPurchaseDirectory && (
                  <Form.Field inline required>
                    <label>
                      What is the yearly fee for Employee Directory?
                    </label>
                    <Input
                      required
